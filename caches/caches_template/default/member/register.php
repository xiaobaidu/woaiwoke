...
#content{width:920px; margin:auto; padding:20px 10px 20px 10px; overflow:auto;background: #FFF;border-radius: 5px;box-shadow: 5px 5px 5px rgba(0,0,0,.2);opacity: 0.8;}
.form-login{width:420px; padding-left:40px}
#content h2{font-size:25px;color:#494949;border-bottom: 1px solid #CCC;padding-bottom:3px; margin-bottom:10px}
...
.form-login .input label{ width:84px;font-size:12px; color:#888; text-align:right;}
...
.form-reg{padding:10px 0 0 14px; width:680px; border-right:1px solid #ccc}
.form-reg .input label{ width:120px;vertical-align:middle;}
.form-reg .input{ height:52px}
.form-reg .input input{ width:220px;font-size:12px; height:38px;color:#666;}
