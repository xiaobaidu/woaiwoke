...
#content{width:920px; margin:auto; padding:36px 0 0 0;background: #fff;height: 450px;border-radius: 5px;box-shadow: 5px 5px 5px rgba(0,0,0,.2);opacity: 0.8;}
.form-login{ width:520px; padding-left:40px}
.form-login h2{font-size:25px;color:#494949;border-bottom: 1px solid #CCC;padding-bottom:3px; margin-bottom:10px}
.form-login .input{ padding:7px 0;height: 52px}
.form-login .input label{ width:84px; color:#888; text-align:right}
.form-login .input input{ width:220px;font-size:12px; height:38px;color:#666;}
...
.col-1{position:relative;  border:1px solid #c4d5df; zoom:1; width:310px; margin: auto; height:304px}
.col-1 span.o1,
	.col-1 span.o2,
	.col-1 span.o3,
...
#footer{color:#9b9b9b; line-height:24px; margin:auto; text-align:center; padding:12px 0;background:#302E31;clear: both}
#footer a{color:#9b9b9b;}
.login-back{background: url(<?php echo IMG_PATH;?>member/logo/background.jpg) no-repeat;height: 700px;padding-top: 120px; }
